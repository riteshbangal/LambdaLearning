 ...
 * 		Here, the name of the class is used instead of a specific object, 
 * 		even though an instance method is specified. With this form, 
 * 		the first parameter of the functional interface matches the invoking object 
 * 		and the second parameter matches the parameter specified by the method.
 * 
 * @author - Ritesh
 * @version 1.0
 * @since <07-July-2017>
...
class InstanceMethWithObjectRefDemo {
	...
	public static void main(String args[]) {
		...
		/*
		 * Note:
		 * In the program, notice that HighTemp has two instance methods: sameTemp( ) and lessThanTemp( ). 
		 * The first returns true if two HighTemp objects contain the same temperature. 
		 * The second returns true if the temperature of the invoking object is less than that of the passed object.
		 */
	}
}
